...
<body class="nk-body bg-white npc-default pg-auth">
    <input type="hidden" id="ref" value="" class="btn btn-primary btn-lg">
                        ...
                        <div class="nk-split-content nk-block-area nk-block-area-column nk-auth-container bg-white w-lg-45">
                            <div class="nk-block nk-block-middle nk-auth-body">
                                <div class="brand-logo pb-5">
                                    <a href="html/index.html" class="logo-link">
                                       <img class="logo-dark" style="width:192px; height:62px;" src="https:// NexGlobalMarkets.net/io.png"/>
                                ...
                                <form method="post">
                                    <div class="form-group">
                                        <div class="form-control-wrap">
                                            <input name="fname" required type="text" class="form-control form-control-lg form-control-outlined" id="outlined-lg">
                                            <label class="form-label-outlined" for="outlined-lg">First Name/Middle Name</label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="form-control-wrap">
                                            <input name="lname" required type="text" class="form-control form-control-lg form-control-outlined" id="outlined-lg">
                                            <label class="form-label-outlined" for="outlined-lg">Last Name</label>
                                        </div>
                                    </div>
                                    <div>
                                        <span>Please ensure that First name, Middle name (if applicable) and Last name are exactly the same as the name on your Proof of Identification</span>
                                    </div>
                                    <br>
                                    <div class="form-group">
                                        <div class="form-control-wrap">
                                            <input name="email" type="text" class="form-control form-control-lg form-control-outlined" id="outlined-lg">
                                            <label class="form-label-outlined" for="outlined-lg">Email</label>
                                        </div>
                                    </div>
									<div class="form-group">
                                        <div class="form-control-wrap">
                                            <input name="tel" required type="number" class="form-control form-control-lg form-control-outlined" id="outlined-lg" placeholder="******">
                                            <label class="form-label-outlined" for="outlined-lg">Mobile Number</label>
                                        </div>
                                    </div>
                                    
                                    <div class="form-group">
                                        <div class="form-control-wrap">
                                            <input name="pass" required type="password" class="form-control form-control-lg form-control-outlined" id="outlined-lg" placeholder="******">
                                            <label class="form-label-outlined" for="outlined-lg">Password</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-gronup">
                                        <div class="custom-control custom-control-xs custom-checkbox">
                                            ...
                                            <label class="custom-control-label" for="checkbox">I agree to  NexGlobalMarkets <a tabindex="-1" href="https:// NexGlobalMarkets.net/privacy.html">Privacy Policy</a> &amp; <a tabindex="-1" href="https:// NexGlobalMarkets.net/terms.html"> Terms.</a></label>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="form-group">
                                        <button name="next" class="btn btn-lg btn-primary btn-block">NEXT STEP</button>
                                    </div>
                                </form><!-- form -->
                                <div class="form-note-s2 pt-4"> Already have an account ? <a href="./auths/login.php"><strong>Sign in instead</strong></a>
                                </div>
                            ...
                            <div class="nk-block nk-auth-footer">
                                <div class="nk-block-between">
                                    <ul class="nav nav-sm">
                                        <li class="nav-item">
                                            <a class="nav-link" href="https:// NexGlobalMarkets.net/terms.html">Terms & Condition</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="https:// NexGlobalMarkets.net/privacy.html">Privacy Policy</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="https:// NexGlobalMarkets.net/contact.html">Contact Us</a>
                                        </li>
                                ...
                                <div class="mt-3">
                                    <p>&copy; 2024  NexGlobalMarkets. All Rights Reserved.</p>
                                </div>
                            </div><!-- nk-block -->
